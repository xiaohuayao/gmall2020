package com.xiaohua.gmall.payment.controller;
...
import com.xiaohua.gmall.payment.config.AlipayConfig;
import com.xiaohua.gmall.service.OrderService;
import com.xiaohua.gmall.service.PaymentService;
...
public class PaymentController {
    ...
    public String alipay(String outTradeNo, BigDecimal totalAmount, HttpServletRequest request, ModelMap modelMap) {
        ...
        map.put("subject","谷粒商城感光徕卡Pro300瞎命名系列");
    ...
    @ResponseBody
    public String getActiveMQ() throws JMSException {

        activeMQUtil.getConnectionFactory().createConnection();
        System.out.println(activeMQUtil.getConnectionFactory().createConnection());
        return "ok";
    }
}
