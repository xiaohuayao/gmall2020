...
import com.xiaohua.gmall.util.JwtUtil;
...
public class PassportController {
    ...
    public String index(String ReturnUrl, Model m){
...
//            }
            ...
            token = JwtUtil.encode("gmall2020", userMap, ip);
    ...
    public String verify(String token, String currentIp,HttpServletRequest request){
        ...
        Map<String, Object> decode = JwtUtil.decode(token, "gmall2020", currentIp);
    ...
    @RequestMapping("vblogin")
    public String vblogin(String code ,HttpServletRequest request){
        // 授权码换取access_token
        // 换取access_token
        // client_secret=32964decc187d1f69e05a22c56e4dfd6
        // client_id=3569271639
